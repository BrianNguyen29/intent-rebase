...
pub trait AuditRepository: Send + Sync {
    ...
    async fn record_rebase_applied(
        ...
        self.record_rebase_applied_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
    ...
    async fn record_rebase_apply_blocked(
        ...
        self.record_rebase_apply_blocked_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
    ...
    async fn record_approval_granted(
        ...
        self.record_approval_granted_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
    ...
    async fn record_approval_revoked(
        ...
        self.record_approval_revoked_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
    ...
    async fn record_approval_expired(
        ...
        self.record_approval_expired_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
    ...
    async fn record_replay_initiated(
        ...
        self.record_replay_initiated_with_trace(
            tenant_id,
            actor_id,
            intent_id,
            payload,
...
pub struct InMemoryAuditRepository {
    pub(crate) events: RwLock<HashMap<Uuid, AuditEvent>>,
    pub(crate) by_intent: RwLock<HashMap<Uuid, Vec<Uuid>>>,
    pub(crate) by_tenant: RwLock<HashMap<Uuid, Vec<Uuid>>>,
}
...
pub(crate) fn audit_event_type_to_string(event_type: &AuditEventType) -> &'static str {
    match event_type {
...
pub(crate) fn audit_event_type_from_string(s: &str) -> AuditEventType {
    match s {
