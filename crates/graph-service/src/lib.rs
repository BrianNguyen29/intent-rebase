...
use intent_rebase_types::{
    ...
    EdgeType, GraphEdge, GraphEdgeFilter, GraphNode, GraphNodeFilter,
    IngestorResult, IntentRebaseError, NodeState, NodeType, PropagationConfig,
    SideEffectIngestRequest, DEFAULT_PROPAGATION_CONFIG,
};
#[allow(unused_imports)]
use intent_rebase_types::{
    CycleDetectionResult, GraphPath, ReachabilityResult, TraversalOptions,
};
