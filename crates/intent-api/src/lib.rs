...
pub(crate) async fn cancel_existing_approved_and_audit(
...
mod tests {
    ...
    // Import trigger reapproval handlers for tests
    use crate::trigger_reapproval_handlers::trigger_reapproval;
