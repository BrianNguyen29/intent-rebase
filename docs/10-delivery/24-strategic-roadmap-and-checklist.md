...
- [ ] **Migration slices 5..N.** Triage the remaining 15 files in survey-slice order (Tier 3 full translations only). *(Out of scope for this slice; deferred.)*
...
**What remains deferred:** Tier 3 full translations (15 files). These are tracked in `24h` §5.2 and §6. The ADR/governance README translations (2 files) and the minor single-word fix (`docs/09-operations/03-observability.md` L28) were completed in Slice B (2026-06-10). The mixed delivery docs (10 files) were completed in Slice C (2026-06-10). Tier 3 Batches 1–4 (`docs/01-product/`, `docs/02-architecture/`, `docs/03-spec/`, `docs/04-api/`) were completed 2026-06-10.
