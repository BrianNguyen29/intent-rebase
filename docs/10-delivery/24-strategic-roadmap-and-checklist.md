...
- [ ] **Migration slices 3..N.** Triage the remaining files in survey-slice order (Tier 3 full translations only). *(Out of scope for this slice; deferred.)*
...
**What remains deferred:** Tier 3 full translations (34 files). These are tracked in `24h` §5.2 and §6. The ADR/governance README translations (2 files) and the minor single-word fix (`docs/09-operations/03-observability.md` L28) were completed in Slice B (2026-06-10). The mixed delivery docs (10 files) were completed in Slice C (2026-06-10).
