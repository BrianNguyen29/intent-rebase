...
- [ ] **Migration slices 9..N.** Triage the remaining 4 files in survey-slice order (Tier 3 full translations only). *(Out of scope for this slice; deferred.)*
...
**What remains deferred:** Tier 3 full translations (4 files). These are tracked in `24h` §5.2 and §6. The ADR/governance README translations (2 files) and the minor single-word fix (`docs/09-operations/03-observability.md` L28) were completed in Slice B (2026-06-10). The mixed delivery docs (10 files) were completed in Slice C (2026-06-10). Tier 3 Batches 1–8 (`docs/01-product/`, `docs/02-architecture/`, `docs/03-spec/`, `docs/04-api/`, `docs/05-data/`, `docs/06-backend/`, `docs/07-frontend/`, `docs/08-security/`) were completed 2026-06-10.
