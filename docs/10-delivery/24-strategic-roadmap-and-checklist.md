...
- [ ] **Migration slices 3..N.** Triage the remaining files in survey-slice order (Tier 3 full translations, mixed delivery docs). *(Out of scope for this slice; deferred.)*
...
**What remains deferred:** Tier 3 full translations (36 files), mixed delivery docs (11 files). These are tracked in `24h` §5.2–§5.6 and §6. The ADR/governance README translations (2 files) and the minor single-word fix (`docs/09-operations/03-observability.md` L28) were completed in Slice B (2026-06-10).
