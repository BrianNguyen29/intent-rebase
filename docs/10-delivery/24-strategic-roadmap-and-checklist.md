...
- [x] **Slice B — ADR/governance README translations + minor single-word fix.** Executed 2026-06-10. `docs/13-adrs/README.md` and `docs/14-governance/README.md` translated; `docs/09-operations/03-observability.md` L28 fixed (`với` → `with`). Evidence in `25b-documentation-language-slice-b-evidence.md`.
- [x] **Slice C — mixed delivery docs translation.** Executed 2026-06-10. Ten mixed English/Vietnamese delivery docs translated: `docs/10-delivery/02-phase-0-foundations.md`, `03-phase-1-core-control-plane.md`, `06-phase-4-expansion.md`, `11-phase-2b-sign-off-packet.md`, `checklists/README.md`, `checklists/checklist-phase-0.md`, `checklists/checklist-phase-1.md`, `checklists/checklist-phase-2.md`, `checklists/checklist-phase-3.md`, `checklists/checklist-phase-4.md`. Evidence in `25c-documentation-language-slice-c-evidence.md`.
- [x] **Tier 3 Batch 1 (`docs/01-product/`).** Executed 2026-06-10. Five files translated. Evidence: `25e`. Remaining Tier 3: 29 files.
- [x] **Tier 3 Batch 2 (`docs/02-architecture/`).** Executed 2026-06-10. Five files translated. Evidence: `25f`. Remaining Tier 3: 24 files.
- [x] **Tier 3 Batch 3 (`docs/03-spec/`).** Executed 2026-06-10. Six files translated. Evidence: `25g`. Remaining Tier 3: 18 files.
- [x] **Tier 3 Batch 4 (`docs/04-api/`).** Executed 2026-06-10. Three files translated. Evidence: `25i`. Remaining Tier 3: 15 files.
- [x] **Tier 3 Batch 5 (`docs/05-data/`).** Executed 2026-06-10. Two files translated. Evidence: `25j`. Remaining Tier 3: 13 files.
- [x] **Tier 3 Batch 6 (`docs/06-backend/`).** Executed 2026-06-10. Four files translated. Evidence: `25k`. Remaining Tier 3: 9 files.
- [x] **Tier 3 Batch 7 (`docs/07-frontend/`).** Executed 2026-06-10. One file translated. Evidence: `25l`. Remaining Tier 3: 8 files.
- [x] **Tier 3 Batch 8 (`docs/08-security/`).** Executed 2026-06-10. Four files translated. Evidence: `25m`. Remaining Tier 3: 4 files.
- [x] **Tier 3 Batch 9 (final batch).** Executed 2026-06-10. Four files translated (`docs/11-quality/`, `docs/12-agents/`, `docs/99-reference/`). Evidence: `25n`. Remaining Tier 3: 0 files. All Tier 3 full translations complete.
...
**What remains deferred:** None — all Tier 3 full translations are complete (34 files). The ADR/governance README translations (2 files) and the minor single-word fix (`docs/09-operations/03-observability.md` L28) were completed in Slice B (2026-06-10). The mixed delivery docs (10 files) were completed in Slice C (2026-06-10). Tier 3 Batches 1–9 were completed 2026-06-10. Remaining future work (if any) is limited to optional public-doc policy pointers or new doc authoring, not translation backlog.
...
| `docs/10-delivery/25-remaining-todo-list.md` | Canonical internal remaining todo-list from verified audit; encodes the deferred follow-up items from this roadmap and the tracker |
...
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Remaining todo list added — `docs/10-delivery/25-remaining-todo-list.md` created as the canonical internal remaining todo-list from the verified audit. Encodes completed work (Phase 0–3 non-production, 24b–24j strategic items, Tier 1/2 language migration, checklist cleanup, local verification refresh, OpenAPI spectral pass), local-executable remaining tasks (Tier 3 translations, ADR/governance READMEs, mixed delivery docs, code TODOs, stale contradiction cleanup, intent-cli short flag audit, benchmark manifest symmetry), risky/design-first items, and external-gated blockers. Companion update-log rows added to this document §14 and to `23-project-assessment-and-execution-tracker.md` §13. No public docs touched. No code changes. No production-readiness claim. External gates (A-03..A-13) remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Slice B executed — ADR/governance README translations + minor single-word fix. `docs/13-adrs/README.md` and `docs/14-governance/README.md` translated from Vietnamese to English in place (~25 lines total). `docs/09-operations/03-observability.md` L28 `với` → `with`. §9.6.b updated: Slice B marked complete; deferred list narrowed to Tier 3 + mixed delivery docs. §9.14 deferred list updated. New internal evidence doc `docs/10-delivery/25b-documentation-language-slice-b-evidence.md` records classification, changed files, line counts, verification results, and non-production caveat. Vietnamese-diacritic scan clean. `git diff --check` pass. No public docs touched. No new `.vi.md`. No code changes. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Slice C executed — mixed delivery docs (10 files) translated from Vietnamese/mixed to English in place (~40 lines total). Files: `docs/10-delivery/02-phase-0-foundations.md`, `03-phase-1-core-control-plane.md`, `06-phase-4-expansion.md`, `11-phase-2b-sign-off-packet.md`, `checklists/README.md`, `checklists/checklist-phase-0.md`, `checklists/checklist-phase-1.md`, `checklists/checklist-phase-2.md`, `checklists/checklist-phase-3.md`, `checklists/checklist-phase-4.md`. Preserved tables, checklists, status caveats, and task-status semantics. §9.6.b updated: mixed delivery docs marked complete; remaining deferred narrowed to Tier 3 full translations only. §9.14 deferred list updated. New internal evidence doc `docs/10-delivery/25c-documentation-language-slice-c-evidence.md` records classification, changed files, segments translated, verification results, and non-production caveat. Vietnamese-diacritic scan clean on all ten target files. Public-doc leakage scan clean. Affirmative-claim scan clean. No new `.vi.md`. `git diff --check` pass. No public docs touched. No code changes. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | 25d low-risk remaining tasks evidence recorded — `docs/10-delivery/25d-low-risk-remaining-tasks-evidence.md` created. Consolidates D2 (`graph.rs` placeholder wording), G (benchmark manifest symmetry), F (CLI short-flag audit/fix), E (stale contradiction cleanup: A-09 continuation note, C-8 wording polish), and D1 deferred rationale. `23-project-assessment-and-execution-tracker.md` §13 gains companion row. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 1 (`docs/01-product/`) translated. Five files (`01-product-thesis.md`, `02-goals-nongoals.md`, `03-core-principles.md`, `04-use-cases.md`, `05-glossary.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 1 marked complete; remaining deferred narrowed from 34 to 29 files. §9.14 deferred list updated. New evidence doc `docs/10-delivery/25e-documentation-language-tier3-product-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 gains companion row. Verification: Vietnamese-diacritic scan clean on all five target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 2 (`docs/02-architecture/`) translated. Five files (`01-system-overview.md`, `02-components.md`, `03-trust-boundaries.md`, `04-scaling-topology.md`, `05-deployment-models.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 2 marked complete; remaining deferred narrowed from 29 to 24 files. §9.14 deferred list updated. Policy Snapshot section in `01-system-overview.md` labeled as historical implementation detail preserved verbatim. New evidence doc `docs/10-delivery/25f-documentation-language-tier3-architecture-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 gains companion row. Verification: Vietnamese-diacritic scan clean on all five target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 3 (`docs/03-spec/`) translated. Six files (`01-intent-model.md`, `02-semantic-diff.md`, `03-dependency-graph.md`, `04-rebase-engine.md`, `05-compensation.md`, `06-provenance.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 3 marked complete; remaining deferred narrowed from 24 to 18 files. §9.14 deferred list updated. Phase 1 Status block in `04-rebase-engine.md` preserved verbatim (already English). Schemas, code blocks, and English type lists preserved verbatim across all six files. New evidence doc `docs/10-delivery/25g-documentation-language-tier3-spec-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 gains companion row. Verification: Vietnamese-diacritic scan clean on all six target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 4 (`docs/04-api/`) translated. Three files (`01-rest-api.md`, `02-events.md`, `03-webhooks.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 4 marked complete; remaining deferred narrowed from 18 to 15 files. §9.14 deferred list updated. Blockquotes, JSON examples, API paths, schemas, event names, and existing caveats preserved verbatim across all three files. Chinese example value `chk_after_approval_收集` left untouched as example data. New evidence doc `docs/10-delivery/25i-documentation-language-tier3-api-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 and `25-remaining-todo-list.md` §2.E gain companion rows. Verification: Vietnamese-diacritic scan clean on all three target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 5 (`docs/05-data/`) translated. Two files (`02-storage.md`, `03-dataflow.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 5 marked complete; remaining deferred narrowed from 15 to 13 files. §9.14 deferred list updated. Code blocks, tables, URLs, identifiers, and examples preserved verbatim across both files. New evidence doc `docs/10-delivery/25j-documentation-language-tier3-data-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 and `25-remaining-todo-list.md` gain companion rows. Verification: Vietnamese-diacritic scan clean on both target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 6 (`docs/06-backend/`) translated. Four files (`01-service-boundaries.md`, `02-runtime-integration.md`, `04-consistency-model.md`, `05-failure-handling.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 6 marked complete; remaining deferred narrowed from 13 to 9 files. §9.14 deferred list updated. Boundary rules, runtime hooks, consistency techniques, and failure action labels preserved verbatim across all four files. New evidence doc `docs/10-delivery/25k-documentation-language-tier3-backend-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 and `25-remaining-todo-list.md` gain companion rows. Verification: Vietnamese-diacritic scan clean on all four target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 7 (`docs/07-frontend/`) translated. One file (`02-ux-flows.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 7 marked complete; remaining deferred narrowed from 9 to 8 files. §9.14 deferred list updated. Flow step labels and UX principle prose translated; action keywords, UI element names, and bullet structure preserved verbatim. New evidence doc `docs/10-delivery/25l-documentation-language-tier3-frontend-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 and `25-remaining-todo-list.md` gain companion rows. Verification: Vietnamese-diacritic scan clean on target file; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen (via authorized assistant fixer) | Tier 3 Batch 8 (`docs/08-security/`) translated. Four files (`01-threat-model.md`, `02-authn-authz.md`, `03-privacy-and-data-handling.md`, `04-audit-and-compliance.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 8 marked complete; remaining deferred narrowed from 8 to 4 files. §9.14 deferred list updated. Threat labels, permission names, data categories, audit event properties, and code blocks preserved verbatim across all four files. New evidence doc `docs/10-delivery/25m-documentation-language-tier3-security-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13 and `25-remaining-todo-list.md` gain companion rows. `24h` §10 update log gains Batch 8 row. Verification: Vietnamese-diacritic scan clean on all four target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
| 2026-06-10 | BrianNguyen29 (via authorized assistant fixer) | Tier 3 Batch 9 (final batch) translated. Four files (`03-acceptance-and-uat.md`, `01-agent-implementation-guide.md`, `03-prompts-contracts.md`, `01-rationale-and-external-patterns.md`) translated from Vietnamese to English in place. §9.6.b updated: Tier 3 Batch 9 marked complete; remaining deferred narrowed from 4 to 0 files. §9.14 deferred list updated to reflect all Tier 3 translations complete (34 files total). New evidence doc `docs/10-delivery/25n-documentation-language-tier3-final-evidence.md` created with internal solo sign-off. `23-project-assessment-and-execution-tracker.md` §13, `25-remaining-todo-list.md`, and `24h` §10 update log gain companion rows. Verification: Vietnamese-diacritic scan clean on all four target files; public-doc leakage scan clean; affirmative-claim scan clean; no new `.vi.md`; `git diff --check` pass. No public docs touched. No code changes. No production-readiness claim. External gates remain blocked. A-11 remains deferred/SDK-blocked. |
