...
| **P1** | External SRE sign-off | Obtain external SRE review and approval | SRE | 🟡 SELF-ATTESTED-SOLO — EXTERNAL RE-SIGNOFF NOT OBTAINED. Historical 2026-06-15 `APPROVED WITH CONDITIONS` by DuongNguyen remains on record. Post-2026-06-15 changes reviewed by project owner (self-attestation) for private-only operation. FIND-001 and FIND-004 remain open. External re-signoff not obtained. For production/public claims, external re-signoff is required. See `docs/13-adrs/16-solo-private-operation-waiver.md`. |
| **P1** | External security sign-off | Obtain external security review and approval | Security | 🟡 SELF-ATTESTED-SOLO — EXTERNAL RE-SIGNOFF NOT OBTAINED. Historical 2026-06-15 `APPROVED WITH CONDITIONS` by DuongNguyen remains on record. Post-2026-06-15 changes reviewed by project owner (self-attestation) for private-only operation. FIND-002, FIND-003 broader secret rotation, and A-07 remain open. External re-signoff not obtained. For production/public claims, external re-signoff is required. See `docs/13-adrs/16-solo-private-operation-waiver.md`. |
...
| **P1** | Penetration testing | Engage external pen test and remediate findings | Security | 🔴 NOT APPROVED — ZAP self-scan prep only (0 FAIL, 1 WARN accepted); external pen test not engaged. No external tester engaged. No self-scan or assistant-generated note substitutes for an external pen test. |
