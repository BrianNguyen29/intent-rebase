...
| **P2** | DLQ/NATS lifecycle | Implement full DLQ replay worker (after G1-G5 gates). G1 closed (solo self-review), G3 closed (local-dev promtool validation), G5 bounded pass; full worker scope remains Phase 4+ deferred. | Backend Lead | 🔴 Deferred — full DLQ replay worker remains Phase 4+ |
