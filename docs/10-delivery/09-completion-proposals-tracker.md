...
|------|------------|---------|
| May 2026 | (fixer) | P2 updated: Webhook delivery bounded slice B3-B16 delivered — env-gated dispatcher, retry loop, metrics, RB13 runbook, `WebhookDeliveryFailureRate` alert, RLS tests; runbook references updated RB6-RB13 |
