...
This document set defines standards for **audit, governance, compliance, and security** for the Intent Rebase Engine. It includes specs and guidelines that the security, compliance, and SRE teams need to operate the system at production level.

---

## Document Index

| ID | Title | Phase | Purpose |
|----|---------|-------|---------|
| [01](./01-audit-event-spec.md) | Audit Event Specification | P1+ | Canonical event schema for audit trail |
| [02](./02-provenance-spec.md) | Provenance Specification | P1+ | Artifact provenance chain and verification |
| [03](./03-policy-snapshot-spec.md) | Policy Snapshot Specification | P1+ | Immutable policy snapshots for compliance |
| [04](./04-approval-revalidation.md) | Approval Scope & Revalidation | P1+ | Approval invalidation and revalidation specs |
| [05](./05-immutable-retention-tamper-resistance.md) | Immutable Retention & Tamper Resistance | P2+ | Data immutability and tamper detection |
...
| [10](./10-forensic-bundle.md) | Forensic Bundle | P3 | Forensic bundle structure and replay |
| [11](./11-incident-freeze.md) | Incident Freeze | P2+ | Data freeze during incident investigation |
| [12](./12-replay-compatibility.md) | Replay Compatibility | P2+ | Replay guarantees and compatibility |
| [13](./13-residual-risk-spec.md) | Residual Risk Specification | P3 | Risk acceptance and residual risk tracking |
