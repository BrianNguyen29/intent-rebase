...
| Staging synthetic data seeded | ✅ Done | Authenticated API calls into namespace `intent-rebase-staging` (2026-06-19). 2 synthetic tenants (`9a47fec7-f5e8-4fda-b676-c8f0aace455b`, `b38d546d-30f2-401e-92f6-59c12a9b5444`), 5 intents created (all `201`), 5 version-2s created (all `201`). Intent IDs: `ac55015d-6545-4fc9-94ee-0c695565fb24`, `0c2e5847-c5a6-4bbd-be64-16429d3fc629`, `cc9ee0d0-723f-400b-9d43-153a84cf3739` (tenant 1); `1ca1ca80-079e-4714-bdaf-8485219e608d`, `1455f78e-a67a-4138-8f6e-277bb0c7b4e0` (tenant 2). Markers: `TENANT_COUNT 2`, `INTENT_COUNT 5`, `VERSION2_COUNT 5`, `STAGING_SYNTHETIC_DATA_SEEDED`. JWT token read out-of-band only; not printed or committed. No production data or credentials used. **Caveat:** Approval scenarios, audit/webhook/runtime-adapter mocks are not seeded. |
